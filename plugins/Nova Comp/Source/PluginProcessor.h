...
class NovaCompAudioProcessor : public juce::AudioProcessor
{
public:
    NovaCompAudioProcessor();
    ~NovaCompAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NovaCompAudioProcessor)
};
